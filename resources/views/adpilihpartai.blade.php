...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <link rel="stylesheet" href="{{('assets/css/adpilihpartai.css')}}" type="text/css">
        <style>
          ...
          <div class="rectangle">
            ...
            <div class="rectangle-2">
                ...
                <div class="info-1">
                    ...
                    <div class="rbutton-3">
                        <a class="edit-1" href="/pilih+anggota">
                        <div class="edit-11">
                        <span class="text-4-2">
                            Pilih
                        </span>
                ...
                <div class="info-2">
                  ...
                  <div class="rbutton-4">
                    <a class="edit-2" href="/pilih+anggota">
                    <div class="edit-22">
                      <span class="text-5-2">
                        Pilih
                      </span>
                ...
                <div class="info-3">
                  ...
                  <div class="rbutton-5">
                    <a class="edit-3" href="/pilih+anggota">
                    <div class="edit-33">
                      <span class="text-6-2">
                        Pilih
                      </span>
                ...
                <div class="info-4">
                  ...
                  <div class="rbutton-6">
                    <a class="edit-4" href="/pilih+anggota">
                    <div class="edit-44">
                      <span class="text-7-2">
                        Pilih
                      </span>
                ...
                <div class="info-5">
                  ...
                  <div class="rbutton-7">
                    <a class="edit-5" href="/pilih+anggota">
                    <div class="edit-55">
                      <span class="text-8-2">
                        Pilih
                      </span>
                ...
                <div class="info-6">
                  ...
                  <div class="rbutton-8">
                    <a class="edit-6" href="/pilih+anggota">
                    <div class="edit-66">
                      <span class="text-9-2">
                        Pilih
                      </span>
                ...
                <div class="info-7">
                  ...
                  <div class="rbutton-9">
                    <a class="edit-7" href="/pilih+anggota">
                    <div class="edit-77">
                ...
                <div class="info-8">
                  ...
                  <div class="rbutton-10">
                    <a class="edit-8" href="/pilih+anggota">
                    <div class="edit-88">
                ...
                <div class="info-9">
                  ...
                  <div class="rbutton-11">
                    <a class="edit-9" href="/pilih+anggota">
                    <div class="edit-99">
                ...
                <div class="info-10">
                  ...
                  <div class="rbutton-12">
                    <a class="edit-10" href="/pilih+anggota">
                    <div class="edit-100">
                ...
                <div class="info-11">
                  ...
                  <div class="rbutton-13">
                    <a class="edit-110" href="/pilih+anggota">
                    <div class="edit-1100">
                ...
                <div class="info-12">
                  ...
                  <div class="rbutton-14">
                    <a class="edit-12" href="/pilih+anggota">
                    <div class="edit-120">
                ...
                <div class="info-13">
                  ...
                  <div class="rbutton-15">
                    <a class="edit-13" href="/pilih+anggota">
                    <div class="edit-130">
                ...
                <div class="info-14">
                  ...
                  <div class="rbutton-16">
                    <a class="edit-14" href="/pilih+anggota">
                    <div class="edit-140">
                ...
                <div class="info-15">
                  ...
                  <div class="rbutton-17">
                    <a class="edit-15" href="/pilih+anggota">
                    <div class="edit-150">
                ...
                <div class="info-16">
                  ...
                  <div class="rbutton-18">
                    <a class="edit-16" href="/pilih+anggota">
                    <div class="edit-160">
                ...
                <div class="info-17">
                  ...
                  <div class="rbutton-19">
                    <a class="edit-17" href="/pilih+anggota">
                    <div class="edit-170">
                ...
                <div class="info-18">
                  ...
                  <div class="rbutton-20">
                    <a class="edit-18" href="/pilih+anggota">
                    <div class="edit-180">
